...
Image = imread("V:\Image-Processing-Projects\ImageSet2\Testimage5.tif");
%% 
...
R = imcrop(R,[STATS2.BoundingBox(k,1) + 10, STATS2.BoundingBox(k,2) + 10,...
    STATS2.BoundingBox(k,3) - 10, STATS2.BoundingBox(k,4) - 10]);
%figure
imshow(R);
